...
import com.example.note.ui.NoteActivity
import com.example.note.ui.NoteViewState
import com.example.note.ui.getColorInt
import io.mockk.*
...
class NoteViewModelTest {
    ...
    private val testNote = Note("hke73d", "title", "body")
    ...
    fun should_set_toolbar_color() {
        ...
        onView(withId(R.id.toolbar)).check { view, _ ->
            assertTrue(
                "toolbar background color doesn't match",
